...
Функция СоответствиеКлассификаторовИМакетов() Экспорт
	...
	Результат.Вставить("ОснованияСпециальногоСтажа", Справочники.ОснованияСпециальногоСтажа.ПолучитьМакет("Классификатор"));
...
Функция ПолучитьНастройкиПоУмолчанию() Экспорт
	...
	Результат = Новый Структура("ЗагружатьНормативныеВеличины, ЗагружатьКурсыВалют, ЗагружатьКлассификаторы, ЗагружатьНовости, ЗагружатьКалендарь, ОткрыватьИнформациюПриСтарте, ЗагружатьДанныеПриСтарте, КоличествоНовостей, УчетныеДанные", Ложь, Истина, Ложь, Ложь, Ложь, Ложь, Ложь, 20, Неопределено);
